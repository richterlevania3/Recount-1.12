...
local revision = tonumber(string.sub("$Revision: 1126 $", 12, -3))
...
--	Recount.Colors:UnregisterItem(Recount.DetailWindow.Title)
	...
	theFrame.LeftButton:SetScript("OnClick",function() Recount:DetailWindowPrevMode() end)
	...
	theFrame.RightButton:SetScript("OnClick",function() Recount:DetailWindowNextMode() end)
	...
	theFrame.ReportButton:SetScript("OnClick",function() Recount:ShowReport("Detail",Recount.ReportDetail) end)
	...
	for i=1,17 do
		...
		Row:SetScript("OnMouseDown",function(this) Recount:SetDeathLogDetails(this.id) end)
...
function me:ConfigureDeathCheckbox(check)
	check:SetWidth(20)
	check:SetHeight(20)
	check:SetScript("OnClick",function(this) if this:GetChecked() then this:SetChecked(true) else this:SetChecked(false) end me:DetermineDeathFilters() end)
